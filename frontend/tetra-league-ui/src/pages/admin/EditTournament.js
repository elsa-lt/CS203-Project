...
const EditTournament = () => {
    ...
    const [tournamentDetails, setnewTournamentDetails] = useState({
    name: '',
    description: '',
    dateTime: '',
    venue: '',
      ...
      >
        <div className="w-1/2 p-8 relative">
          <div className="relative top-10 left-60 text-center">
            <img src="/Headers/Edit Tournaments Header.png" alt="Profile" className="w-72 md:w-6/12 -ml-80" style={{ width: '550px' }} />
          </div>
        </div>
        ...
        <div className="tournament-creator ">
          <div className="w-full max-w-6xl bg-white opacity-70 rounded-lg shadow-lg p-6 h-[600px] overflow-y-auto -ml-10 mt-10">
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" className="w-full bg-black text-white font-semibold py-2 px-4 rounded-lg opacity-100">OK</button>
            </form>
          </div>
        </div>
      </main>
