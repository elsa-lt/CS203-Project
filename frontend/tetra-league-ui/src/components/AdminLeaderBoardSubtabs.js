...
const AdminLeaderBoardSubtabs = ({ username }) => {
    ...
    <div className="w-full mx-auto">
      {loading ? (
        ...
        <>
          ...
          <div className="w-full max-w-6xl bg-white opacity-70 rounded-lg shadow-lg p-6 h-[550px] overflow-y-auto -ml-2">
...
export default AdminLeaderBoardSubtabs;